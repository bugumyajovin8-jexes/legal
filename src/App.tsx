          ...
          <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-10">
            {activeTab === 'privacy' ? (
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <h2 className="text-xl font-semibold text-slate-900 mt-8 mb-4">10. Pricing and Payments</h2>
                ...
                <p className="mb-4 text-slate-700 leading-relaxed">Payments are non-refundable.</p>
